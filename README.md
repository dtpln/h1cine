...
<img src="https://img.shields.io/badge/REWRITE%20IN%20PROGRESS-f68d3d?style=flat-square">　<a href="https://github.com/dtpln/h1cine/releases"><img src="https://img.shields.io/github/v/release/dtpln/h1cine?label=Latest%20release&style=flat-square&color=f68d3d"></a>　<a href="https://discord.gg/wgRJDJJ"><img src="https://img.shields.io/discord/617736623412740146?label=Join%20the%20IW4Cine%20Discord!&style=flat-square&color=f68d3d"></a>  
<br/><br/>
...
In order to use the latest version of this mod directly from the repo, you'll need a copy of **Call of Duty®: Modern Warfare Remastered®** with the **[Alterware](https://alterware.dev)** client installed.
...
Once the mod is downloaded, open the ZIP file and drag the contents of the "h1cine" folder into your `Call of Duty Modern Warfare Remastered/mods` folder.
...
└── .../
    └── Call of Duty Modern Warfare Remastered/
        └── mods/
            └── h1cine/
```
Then, open your game, and click on the "Mods" tab; "h1cine" should appear in the list. Click on it once and then click on "Launch" to restart your game with the mod on.
...
<br/><br/>
## Features
- Check **[FEATURES.md](https://github.com/dtpln/h1cine/blob/main/FEATURES.md)**
