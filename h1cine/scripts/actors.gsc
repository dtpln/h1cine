...
add( args )
{
    base_body = "body_sas_ct_sniper_mp_camo";
    base_head = "head_spetsnaz_urban_smg_mp";
    base_anim = "pb_stand_remotecontroller";
    base_dead = "pb_stand_death_chest_blowback";
...
prepare_gopro()
{
    ...
    level.gopro.object setModel( "wpn_h1_lau_rpg7_proj" );
