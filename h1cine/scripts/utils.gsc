...
MsgHelp()
{
	...
	setDvarIfUninitialized("mvm_help", "Get a full list of mod commands.");
	for (;;)
	{
		if(getdvar("mvm_help") != "Get a full list of mod commands.")
		{
            self iPrintLnBold( "[" + level.HIGHLIGHT_COLOR + "H1Cine^7] All commands printed to the console." );
			print( " " );
            print( "=============================================================================================");
            print( "^3H1Cine Help Message" );
            print( "Please refer to the key before asking questions!" );
			print( "**KEY**" );
            print( " " );
            print( "[^1x^7] = done" );
            print( "[ ] = not done" );
            ...
            print( " " );
            print( "[^1x^7]   clone             -- <set to 1>" );
            print( "[^1x^7]   drop              -- <set to 1>" );
            print( "[ ]   about             -- <set to 1>" );
            print( "[^1x^7]   clearbodies       -- <set to 1>" );
            print( "[^1x^7]   viewhands         -- <model_name>" );
            print( "[^1x^7]   eb_explosive      -- <radius>" );
            print( "[^1x^7]   eb_magic          -- <degrees>" );
            print( "[^1x^7]   spawn_model       -- <model_name>" );
            print( "[ ]   spawn_fx          -- <fx_name>" );
            print( "[^1x^7]   vision            -- <vision>" );
            print( "[^1x^7]   fog               -- <start> <half> <red> <green> <blue> <time>" );
            print( " " );
            print( "**BOT FUNCTIONS**" );
            print( " " );
            print( "[ ]   spawn             -- <weapon_mp> <allies/axis> <model>" );
            print( "[ ]   weapon            -- <bot_name> <weapon_name> <camo_name>" );
            print( "[ ]   move              -- <bot_name>" );
            print( "[ ]   aim               -- <bot_name>" );
            print( "[ ]   stare             -- <bot_name>" );
            print( "[ ]   model             -- <bot_name> <MODEL> <allies/axis>" );
            print( "[ ]   kill              -- <bot_name> <body/head/shotgun>" );
            print( "[ ]   holdgun" );
            print( "[ ]   freeze            -- <set to 1>" );
            print( " " );
            print( "**ACTOR FUNCTIONS**" );
            print( " " );
            print( "[ ]   actorback         -- <set to 1>" );
            print( "[ ]   actor_anim        -- <actor_name> <anim_name>" );
            print( "[ ]   actor_copy" );
            print( "[ ]   actor_death" );
            print( "[ ]   actor_spawn       -- <body_model> <head_model> <anim_name> <death_anim>" );
            print( "[ ]   actor_move        -- <actor_name>" );
            print( "[ ]   actor_health" );
            print( "[ ]   actor_model" );
            print( "[ ]   actor_weapon" );
            print( "[ ]   actor_gopro" );
            print( "[ ]   actor_fx" );
            print( " " );
            print( "**CAMERA FUNCTIONS**" );
            print( " " );
            print( "[^1x^7]   mode              -- <linear/bezier>" );
            print( "[^1x^7]   rot               -- <degrees>" );
            print( "[^1x^7]   save              -- <node # starting from 1>" );
            print( "[^1x^7]   start             -- <speed if bezier, time if linear>" );
			print( "=============================================================================================");
			setdvar("mvm_help", "Get a full list of mod commands.");
		}
		wait 0.5;
	}
}