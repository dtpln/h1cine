...
load_defaults()
{
    ...
    level.COMMAND_COLOR             = "^4";     // "^#" - q3 color code for the commands' descriptions and killfeed messages. Can be blank ("") to disable globally.
    ...
    level.MATCH_KILL_SCORE          = 1;      // integer - The default score per kill
    ...
    level.BOT_FREEZE                = true;    // [true/false] - Changes all testclients dvars (except _watchKillcam) to make them static
